...
export default function OwnerListingsSection({
  ...
  return (
    <section className="mt-14">
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-1 text-[15px] text-slate-500">
            Керуйте вашими активними та архівними публікаціями
          </p>
        </div>
        ...
        <button
          ...
          className="inline-flex h-12 items-center justify-center gap-2 self-start rounded-2xl bg-primary px-6 text-[15px] font-medium text-white shadow-[0_10px_25px_rgba(22,155,98,0.24)] transition hover:opacity-90"
        >
      ...
      <div className="overflow-hidden rounded-[24px] bg-white shadow-[0_8px_30px_rgba(15,23,42,0.05)]">
        <div className="hidden grid-cols-[2.4fr_1.2fr_1fr_1fr_1fr_0.5fr] gap-4 border-b border-slate-100 px-6 py-4 text-[12px] font-semibold uppercase tracking-wide text-slate-400 lg:grid">
          <span>Об'єкт</span>
          <span>Район</span>
          <span>Ціна</span>
          <span>Статус</span>
        ...
        <div className="divide-y divide-slate-100">
          {items.map((listing) => (
            <div
              key={listing.id}
              className="grid gap-4 px-6 py-5 lg:grid-cols-[2.4fr_1.2fr_1fr_1fr_1fr_0.5fr] lg:items-center"
            >
              ...
              <div>
                ...
                >
                  ...
                  />
                  {listing.status === "active" ? "Активне" : "Архівне"}
                </span>
              </div>

              <div className="flex items-center gap-2 text-slate-500">
                <Eye className="h-4 w-4" />
                {listing.views.toLocaleString("uk-UA")}
              </div>
